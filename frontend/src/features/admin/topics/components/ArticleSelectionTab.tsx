...
import type { ArticleSearchFilters } from "@/components/common/ArticleSearchFilters";
...
export default function ArticleSelectionTab({
  ...
  const [appliedFilters, setAppliedFilters] = useState<ArticleSearchFilters>({
    startDate: "",
    endDate: "",
    labelTags: [],
    searchQuery: "",
  ...
  // 新しい検索フィルターハンドラ
  const handleFiltersSearch = (filters: ArticleSearchFilters) => {
